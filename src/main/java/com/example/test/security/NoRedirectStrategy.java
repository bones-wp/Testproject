...
/**
 * Поскольку мы защищаем REST API, в случае сбоя аутентификации сервер не должен перенаправлять ни на одну страницу
 * с ошибкой. Сервер просто вернет HTTP 401
 */
