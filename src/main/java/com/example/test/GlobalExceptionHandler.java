...
/**
 * Для того чтобы видеть ошибки авторизации или валидации токена, создаем новый класс GlobalExceptionHandler
 * (обработчик ошибок) в корне проекта, который является расширением класса ResponseEntityExceptionHandler
 * с реализацией метода handleAuthenticationException.
 */
